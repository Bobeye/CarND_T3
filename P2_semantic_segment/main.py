...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # TODO: Implement function
    #1x1 conv
    conv_1x1 = tf.layers.conv2d(vgg_layer7_out, 512, 1, strides=(1,1))    
    #upsampling
    upsampling_1 = tf.layers.conv2d_transpose(conv_1x1, 512, 2, strides=(2, 2))
    #skip connection
    fuse_vgg4 = tf.add(upsampling_1, vgg_layer4_out)                                     
    #upsampling
    upsampling_2 = tf.layers.conv2d_transpose(fuse_vgg4, 256, 2, strides=(2, 2))
    #skip connection
    fuse_vgg3 = tf.add(upsampling_2, vgg_layer3_out)                                     
    #upsampling
    output = tf.layers.conv2d_transpose(fuse_vgg3, num_classes, 8, strides=(8, 8), padding='same')
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for epoch in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            total_loss += loss
            N += 1
        print("Epoch %d of %d: Training loss: %.4f" %(epoch+1, epochs, total_loss/N))
