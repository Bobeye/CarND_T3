    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          double left_space_rear = 999.;
          double left_space_front = 999.;
          double right_space_rear = 999.;
          ...
          for (int i=0; i<sensor_fusion.size(); i++) {
            ...
            if(d<(2+4*lane+2) && d>(2+4*lane-2)) { 
              ...
              if ((check_car_s-car_s)>0 && (check_car_s-car_s)<ego_space_front) { // update ego lane front space 
                ego_space_front = (check_car_s-car_s);
            ...
            // left
              ...
              if ((check_car_s-car_s)>0 && (check_car_s-car_s)<left_space_front) {  // update left lane front space
                left_space_front = (check_car_s-car_s);
            ...
            // right
              ...
              if ((check_car_s-car_s)>0 && (check_car_s-car_s)<right_space_front) { // update right lane front space
                right_space_front = (check_car_s-car_s);
          ...
          // cancel right change if rear space or front space on is limited
          if (cost_right > 0 && (right_space_rear/20.)>1 && (right_space_front/20.)>1) {
            cost_right += (right_space_front/100.);
          } else {
            cost_right = 0.;
          }
